...
const getStyle = (tooltipPosition, anchorDimensions, tooltipDimensions, windowDimensions, pointerPosition) => {
    ...
    const key = tooltipPosition + (pointerPosition === 'center' || (tooltipPosition === 'right' || tooltipPosition === 'left') 
        ? '' 
        : (pointerPosition.charAt(0).toUpperCase() + pointerPosition.slice(1) ))
